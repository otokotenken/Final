...
- (void)viewDidLoad {
    [super viewDidLoad];
    _iconsArray = [NSArray arrayWithObjects:@"calender2Icon.png", @"chatIconImage.png", @"todoListIcon.png", nil];
...
//    UICollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
    ...
    menuImageView.image = [UIImage imageNamed:[_iconsArray objectAtIndex:indexPath.row]];
    cell.backgroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"border1.JPG"]];
    return cell;
}
