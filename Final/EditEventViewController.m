...
- (void)viewDidLoad
{
    ...
    if (self.appDelegate.eventManager.selectedEventIdentifier.length > 0) {
        ...
        _eventTitle = self.editedEvent.title;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        switch (indexPath.row) {
            ...
            {
                _titleTextfield = (UITextField *)[cell.contentView viewWithTag:10];
                _titleTextfield.delegate = self;
                _titleTextfield.text = self.eventTitle;
...
-(BOOL)textFieldShouldReturn:(UITextField *)textField{
    self.eventTitle = _titleTextfield.text;
