...
////    self.headerReferenceSize = header;
//    CGSize *header = CGSizeMake(100.0, 10.0);
//    WheelCollectionViewLayout.headerReferenceSize = header;
//    
//    return header;
//}
...
- (NSArray*)layoutAttributesForElementsInRect:(CGRect)rect {
    ...
    [array enumerateObjectsUsingBlock:^(UICollectionViewLayoutAttributes * layoutAttributes, NSUInteger idx, BOOL *stop) {
        ...
        if (pointInMainView.x < self.collectionView.frame.size.width+80.0f){
            ...
            transform = CATransform3DTranslate(transform, centerInMainView.x - rotationPoint.x, centerInMainView.y-rotationPoint.y-15.0f, 0.0);
